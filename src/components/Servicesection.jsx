          ...
          <div className="px-10 lg:px-20 xl:px-20 2xl:px-32 ">
            <div className='w-full space-y-5 xl:space-y-12'>
              ...
              <motion.div {...Motiony}>
                ...
                <div className="space-y-4 xl:space-y-10 bg-white px-5 xl:px-10 p-3 rounded-xl">
                    ...
                    <div className="">
                      <a className="text-black text-sm xl:text-2xl font-extrabold border-black border-b-4" href="">Learn more</a>
                    </div>
                  </div>
                  <div className="space-y-4 xl:space-y-10 bg-emerald-600 px-5 xl:px-10 p-3 rounded-xl">
                    ...
                    <div className="">
                      <a className="text-white text-sm xl:text-2xl font-extrabold border-white border-b-4" href="">Learn more</a>
                    </div>
                  </div>
                  <div className="space-y-4 xl:space-y-10 bg-white px-5 xl:px-10 p-3 rounded-xl">
                    <h1 className="text-black text-lg xl:text-4xl font-extrabold">Paludarium</h1>
