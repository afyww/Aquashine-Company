        ...
        <div className="my-auto ">
          <div className="px-10 lg:px-20 xl:px-20 2xl:px-32 ">
            <div className='w-full space-y-24'>
              ...
              <div>
                <h1 className="text-2xl xl:text-4xl font-extrabold text-gray-800 text-left">What We serve ? </h1>
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-5 p-6 xl:p-8 rounded-2xl">
                  <div className="space-y-10 px-5 xl:px-10 bg-gray-800 p-3 rounded-xl">
                    <h1 className="text-gray-100 text-2xl xl:text-4xl font-extrabold">Aquascape</h1>
                    <p className="text-xs xl:text-sm text-extralight text-gray-100 text-left">Aquascape adalah seni menciptakan dan merancang taman air di dalam akuarium. Ini melibatkan penataan tanaman air, batu, kayu, substrat, dan elemen dekoratif lainnya secara estetis untuk menciptakan lanskap air yang menarik dan alami. Aquascape biasanya dilakukan dalam akuarium yang dirancang khusus untuk meniru lingkungan alami seperti hutan, sungai, dan danau.
                      Dalam praktiknya, aquascaping merupakan kombinasi antara seni dan ilmu pengetahuan, di mana para aquascaper</p>
                    <div className="">
                      <a className="text-gray-100 text-xl xl:text-2xl font-extrabold border-gray-100 border-b-4" href="">Learn more</a>
                    </div>
                  </div>
                  <div className="space-y-10 px-5 xl:px-10 bg-gray-800 p-3 rounded-xl">
                    <h1 className="text-gray-100 text-2xl xl:text-4xl font-extrabold">Paludarium</h1>
                    <p className="text-xs xl:text-sm text-extralight text-gray-100 text-left">
                  ...
                  <div className="border-gray-800 space-y-10 px-5 xl:px-10 bg-gray-800 p-3 rounded-xl">
                    <h1 className="text-gray-100 text-2xl xl:text-4xl font-extrabold">Terrarium</h1>
                    <p className="text-xs xl:text-sm text-extralight text-gray-100 text-left">
