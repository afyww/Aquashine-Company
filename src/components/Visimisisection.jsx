                    ...
                    <div className='w-full'>
                        <div className="space-y-6 xl:space-y-0 grid grid-cols-1 xl:grid-cols-2">
                            <div className='space-y-4'>
                                <h1 className='text-2xl text-white text-center'>Visi</h1>
                                <p className='text-white font-light text-xs xl:text-xl text-left'>Menjadi perusahaan jasa pembuatan pembuatan aquascape, taman, aviary, dan vertical garden yang inovasi dan menginspirasi khalayak umum.</p>
                            </div>
                            <div className='space-y-4'>
                                <h1 className='text-2xl text-white text-center'>Misi</h1>
                                <div className='text-white font-light text-xs xl:text-xl text-left'>
