            ...
            <form onSubmit={handleSubmit}>
                <div className="space-y-1">
                    ...
                    <div className="border-b-2 border-emerald-400 w-fit">
                        <button
                            type="submit"
                            className="text-sm flex gap-2 xl:text-xl text-emerald-600"

                        >Send Message on WhatsApp
                            <svg className='my-auto bg-emerald-400 p-1 h-6 w-6 xl:w-7 xl:h-8' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
